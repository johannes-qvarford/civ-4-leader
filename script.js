...
const LEADERS = [
  ...
  { id: 'augustus',      name: 'Augustus Caesar', civ: 'Rome',          traits: ['Industrious', 'Imperialistic'] },
  { id: 'bismarck',      name: 'Bismarck',        civ: 'Germany',       traits: ['Expansive', 'Industrious'] },
  { id: 'boudica',       name: 'Boudica',         civ: 'Celtia',        traits: ['Aggressive', 'Charismatic'] },
  { id: 'brennus',       name: 'Brennus',         civ: 'Celtia',        traits: ['Spiritual', 'Charismatic'] },
  ...
  { id: 'degaulle',      name: 'De Gaulle',       civ: 'France',        traits: ['Industrious', 'Charismatic'] },
  { id: 'elizabeth',     name: 'Elizabeth',       civ: 'England',       traits: ['Financial', 'Philosophical'] },
  ...
  { id: 'justinian',     name: 'Justinian I',     civ: 'Byzantine',     traits: ['Spiritual', 'Imperialistic'] },
  { id: 'kublai',        name: 'Kublai Khan',     civ: 'Mongolia',      traits: ['Aggressive', 'Creative'] },
  { id: 'lincoln',       name: 'Lincoln',         civ: 'America',       traits: ['Philosophical', 'Charismatic'] },
  ...
  { id: 'napoleon',      name: 'Napoleon',        civ: 'France',        traits: ['Organized', 'Charismatic'] },
  ...
  { id: 'qin',           name: 'Qin Shi Huang',   civ: 'China',         traits: ['Industrious', 'Protective'] },
  ...
  { id: 'saladin',       name: 'Saladin',         civ: 'Arabia',        traits: ['Spiritual', 'Protective'] },
